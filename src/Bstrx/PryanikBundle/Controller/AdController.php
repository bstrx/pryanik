...
use Bstrx\PryanikBundle\Entity\Ad;
...
class AdController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BstrxPryanikBundle:Ad')->findAll();
     ...
     * @Method("POST")
     * @Template("BstrxPryanikBundle:Ad:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BstrxPryanikBundle:Ad')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BstrxPryanikBundle:Ad:edit.html.twig")
     */
